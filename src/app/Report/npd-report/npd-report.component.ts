...
@Component({
  selector: 'app-npd-report',
  templateUrl: './npd-report.component.html',
  styleUrls: ['./npd-report.component.css']
})
export class NpdReportComponent implements OnInit {
...
fetchCheckWeightData:any[]=[]
  ...
  getreport(){
    this.serviceNew.v1_SP_Report_for_Not_Paid_Departed(this.valForm.value).subscribe(d=>{
