...
@Component({
    selector: 'app-hawb',
    templateUrl: './hawbAllocation.html',
})
export class HawbAllocationComponent {
    ...
    constructor( public http: HttpClientModule, fb: FormBuilder,
      ...
      {
        this.dataGrid=true;
        this.service.getBranchHawbAllocation(this.userid.v_point_id,'1').subscribe(get_data=>{
      ...
      getBranchStockStartNo(value:any)
      {
        ...
        var b=value.branchName.split('$')[1];
        //console.log(a,b);
        this.dataGrid=true;
      ...
      edit(branchName:any)
      {
        ...
        // this.valForm.controls['point_id'].setValue(branchName.Receiving_point_name)
    ...
    export(value: any) {
      this.service.getBranchHawbAllocation(this.userid.v_point_id,'1').subscribe(res => {
