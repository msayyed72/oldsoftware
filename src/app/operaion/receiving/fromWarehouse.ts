...
@Component({
    moduleId: module.id,
    templateUrl: './fromWarehouse.html',
})
export class FromWarehouseComponent implements OnInit{

  @ViewChild("inputBox") _el!: ElementRef;
  Destination_receiving_f_warehouse:any;
  Manifest_receiving_f_warehouse:any;
  ...
  console.log("usid",this.userdetails);
  if( this.F_DES){
    this.F_DES.nativeElement.focus()
  }
  this.getDestination_receiving_f_warehouse();
  this.getManifest_receiving_f_warehouse();
  this.valForm.controls['destinationPoint'].setValue(this.userdetails.v_point_id);
  this.valForm.controls['vechile_guide'].setValue(this.userdetails.v_user_id);
  this.valForm.controls['createdBy'].setValue(this.userdetails.v_user_id);
  this.valForm.controls['markedBy'].setValue(this.userdetails.v_user_id);
  this.valForm.controls['scanBy'].setValue(this.userdetails.v_user_id);
  this.valForm.controls['updatedBy'].setValue(this.userdetails.v_user_id);
  ...
  getDestination_receiving_f_warehouse(){
    this.service.getDestination_warehouse_new(this.point_type_id).subscribe(get_data=>{
      this.Destination_receiving_f_warehouse=get_data['data'];
      console.log("Destination_receiving_f_warehouse",this.Destination_receiving_f_warehouse);
    })
  }
  getManifest_receiving_f_warehouse(){
   this.service.getManifest_receiving_f_warehouse(this.userid.v_point_id).subscribe(get_data=>{
     this.Manifest_receiving_f_warehouse=get_data['data'];
     console.log("Manifest_receiving_f_warehouse",this.Manifest_receiving_f_warehouse);
   })
 }
 edit(unit:any)
 {
...
//  this.valForm.controls['drivermobileno'].setValue(unit.driver_mobile_no)
 ...
 console.log('valueupdate', value)
           this.service.UpdateManifest_receiving_f_warehouse(value).subscribe(res2=>{ 
 ...
 booking(){
  this.router.navigate(['/Operation/FromWarehouseManifest',this.minifest_no,this.source_point_id,this.destination_point_id]);
        }
   ...
   if(this.btn=='2')
   {
    ...
    if (this.valForm.valid) {
      this.Save_spin = '1'
        ...
        this.service.InsertManifest_receiving_f_warehouse(value).subscribe(res1=>{ 
...
data(deleteunitData:any){
 ...
 delete()
 {
           ...
           this.service.deleteManifest_receiving_f_warehouse(this.deleteunitData.ptp_mf_no).subscribe(res=>{
           if (res['code'] == '200') {
 ...
 getfrom_branch_reci_available_manifest(){
  ...
  this.service.getfrom_branch_reci_available_manifest(-1,this.destination_point_id).subscribe(get_data=>{
...
changeTableRowColor_rec(idx: any) { 
    this.rowClicked_rec = idx;
}

gobooking_popup()
{
//   console.log('ssss',this.Manifest_receiving_f_warehouse)
// this.popupManager.open('Receiving', 'Do you want to Go Receiving From Warehouse?', 
//     {
//           width: '300px',
...
//               onAction: () =>
//               {
//                 var unit=this.Manifest_receiving_f_warehouse[0]
